...
The Keybinded Filter Preset Mod provides hotkey-control over the targeting filter system to instantly switch to a custom preset, removing the need to repeatedly cycle through the filter list in the heat of combat.
